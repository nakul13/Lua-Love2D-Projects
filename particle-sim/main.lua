...
function displayInit()
  ...
  love.graphics.print('Hit SpaceBar to create a new particle', WINDOW_WIDTH/2 - 280, WINDOW_HEIGHT/2 - 40)
  love.graphics.print('Hit ENTER to destroy all particles', WINDOW_WIDTH/2 - 260, WINDOW_HEIGHT/2 + 40)
...
function displayParticleCount()
    ...
    love.graphics.print('Particles: ' .. tostring(particleCount), 40, 40)
    love.graphics.setColor(0, 0, 0, 255)
end
